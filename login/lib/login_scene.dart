...
import 'package:login/EditAccount.dart';
...
class _LoginState extends State<Login> {
  ...
  Future<void> _login() async {
    final response = await http.post(
      Uri.parse('http://localhost:3000/api/users/login'), // Remplacez par votre URL de connexion
    ...
    if (response.statusCode == 200) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        ...
        Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => EditAccount()), // Remplacez par la page suivante
              );
